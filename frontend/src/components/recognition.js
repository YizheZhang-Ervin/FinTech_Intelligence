...
import voicepic from "../assets/microphone.png";
		...
		return (
			<div className="whole">
                ...
                <section className="top flex">
                    <h1>EZ Intelligence</h1>
                    <button id="takephoto" style={camerabtn} onClick={()=>{this.takePhoto()}}></button>
                </section>
                {/* 中间内容界面 */}
                ...
                <section className="bottom flexv">
                    ...
                    {/* 按钮 */}
                    <button id="start" style={voicebtn} disabled></button>
                    {/* 声音条 */}
